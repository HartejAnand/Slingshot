...
setup = function(){
    ...
    block1 = new Block(windowWidth/3,windowHeight*3/4-30,50,50);
    block2 = new Block(windowWidth/3-50,windowHeight*3/4-30,50,50);
    block3 = new Block(windowWidth/3-100,windowHeight*3/4-30,50,50);
    block4 = new Block(windowWidth/3+50,windowHeight*3/4-30,50,50);
    block5 = new Block(windowWidth/3+100,windowHeight*3/4-30,50,50);
    block6 = new Block(windowWidth/3-150,windowHeight*3/4-30,50,50);
    block7 = new Block(windowWidth/3+150,windowHeight*3/4-30,50,50);

    block8 = new Block(windowWidth/3,windowHeight*3/4-80,50,50);
    block9 = new Block(windowWidth/3-50,windowHeight*3/4-80,50,50);
    block10 = new Block(windowWidth/3-100,windowHeight*3/4-80,50,50);
    block11 = new Block(windowWidth/3+50,windowHeight*3/4-80,50,50);
    block12 = new Block(windowWidth/3+100,windowHeight*3/4-80,50,50);

    block13 = new Block(windowWidth/3,windowHeight*3/4-130,50,50);
    block14 = new Block(windowWidth/3-50,windowHeight*3/4-130,50,50);
    block15 = new Block(windowWidth/3+50,windowHeight*3/4-130,50,50);

    block16 = new Block(windowWidth/3,windowHeight*3/4-180,50,50);
    ...
    projectile = new Projectile(windowWidth/10,windowHeight*5/6);
    sling = new Slingshot(projectile.body,{x:windowWidth/10, y:windowHeight*5/6});
...
draw = function(){
    background(floor(random(220,280)),0,0);
